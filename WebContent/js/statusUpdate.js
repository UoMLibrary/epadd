...
var CANCEL_SELECTOR = '#cancel'; // ideally should be passed in as a param, currently fixed.
// It means nothing else on the page that includes div_status can have a #cancel element

// page: URL to hit that kicks off a long-running operation. We'll ajax fetch this page, and expect a json response with
// fields {error: String, cancelled: boolean, resultPage: String}.
