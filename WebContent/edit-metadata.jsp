...
<script>
	...
	function fillCollectionMetadataFields(node){
		...
		$('#environmentPurpose').val(node.environmentPurpose);
	...
	function updateCollectionNodeWithMetadata(){
		...
		selectedNode[0].environmentPurpose = $('#environmentPurpose').val();
	...
	function fillFileMetadataFields(node){
		...
		$('#file-environmentPurpose').val(node.environmentPurpose);
	...
	function updateFileNodeWithMetadata(){
		...
		selectedNode[0].environmentPurpose = $('#file-environmentPurpose').val();
